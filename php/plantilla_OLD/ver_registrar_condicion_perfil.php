...
<script src="../../js/ver_registrar_condicion_consulta.js"></script>
...
<body >
	<div id="ventana_general"></div>
        ...
        <tr>
          <td align="center" class="titulo_principal">REGISTRO DE CONDICIONES ESPECIALES</td>
        </tr>
      </table>
          <br />
        ...
        <tr >
          ...
          <br />
            ...
            <tr class='titulo_tabla_detalle'>
              <td width="33%" nowrap='nowrap' >MODULO</td>
              <td width="33%" nowrap='nowrap' >ENTIDAD</td>
              <td width="34%">FECHA (DESDE)</td>
            </tr>
		  ...
		  while($row = $db->sacar_registro($cursor_permisos)){ 
			...
			$cod_entidad			= $row['cod_entidad_pk'];
			$fec_consulta			= $row['fec_consulta'];
			...
			$cursor_entidad_ciclo			=	$entidad->f_get_activos();
			$cmb_entidad_ciclo				=	$obj_listbox->f_crear_lista($cursor_entidad_ciclo, $cod_entidad);
		...
		?>
            ...
            <tr valign='top'   id='tabla_16_row_<?php echo $contador; ?>'>
              <td nowrap='nowrap'>                            
                <select class="combo" name='cod_modulo[]' onfocus="this.defaultIndex=this.selectedIndex;" onchange="this.selectedIndex=this.defaultIndex;" >
                  <option value='-1' selected='selected'></option>
                <?php echo $cmb_tablas_autonomas_ciclo; ?>                
                </select></td>
              <td nowrap='nowrap'><select class="combo" name='cod_entidad[]' >
                <option value='-1' selected='selected'></option>
                <?php echo $cmb_entidad_ciclo; ?>
              </select></td>
              <td nowrap='nowrap' align='left'><input 	name		='fec_consulta[]'  
						type		='datetime' class='combo'  
