...
<body >
	<div id="ventana_general"></div>
        ...
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <table width="20%" border="0" align="center" cellpadding="0" cellspacing="3">
          <tr>
            <td align="center"><strong class="texto_impresion">INGRESO DE USUARIOS </strong></td>
          </tr>
          <tr>
            <td align="center"><table width="100%" border="0" cellspacing="5" cellpadding="0">
              <tr>
                <td align="left" class="combo_solicitud"><strong>LOGIN</strong></td>
                <td><input name="txt_login" type="text" id="txt_login" /></td>
              </tr>
              <tr>
                <td align="left" class="combo_solicitud"><strong>PASSWORD</strong></td>
                <td><input name="txt_password" type="password" id="txt_password" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td align="right"><input type="button" name="Submit" value="Entrar"  onclick="navegar(36)"/></td>
              </tr>
            </table></td>
          </tr>
      </table>
