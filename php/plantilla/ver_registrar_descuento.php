...
<title>Registro de Descuento - D E C K</title>
...
<body >
	<div id="ventana_general"></div>
        ...
        <tr>
          <td align="center" class="titulo_principal">GENERACION Y/O ASIGNACION DE DESCUENTO</td>
        </tr>
      </table>
          <br />
        ...
        <tr>
          <td width="23%">&nbsp;</td>
          <td width="54%"><table width="96%" border="0" align="center">
            <tr>
              <td colspan="7" nowrap="nowrap" class="titulo_tabla"> Relacion de Facturas</td>
            </tr>
            <tr class="menu_navegacion_paginas"  >
             <td width="6%" nowrap="nowrap" class="combo_solicitud"><input  type="checkbox" onclick="marcar(this);" checked="checked" /></td>
              <td width="12%" nowrap="nowrap" class="combo_solicitud">Factura</td>
              <td width="13%" class="combo_solicitud">Entidad</td>
              <td width="17%" nowrap="nowrap">Estado</td>
              <td width="19%" nowrap="nowrap">Fecha Generada</td>
              <td width="15%" nowrap="nowrap">Descuento</td>
                <td width="18%" nowrap="nowrap">Valor Total</td>
            </tr>
            ...
            <?php while($row=$db->sacar_registro($cursor_facturas)){
						...
						$val_descuento			= $row['val_descuento1'];
            ...
            <td nowrap="nowrap"><input name="reg_seleccionado[]" type="checkbox" value="<?=$cod_factura?>" checked /></td>
              ...
              <td nowrap="nowrap"><?=$val_descuento?></td>
            ...
            <tr>
              <td colspan="7" nowrap="nowrap" class="combo_solicitud">&nbsp;</td>
            </tr>
            <tr>
              <td colspan="7" nowrap="nowrap" class="combo_solicitud">Valor Descuento ($): &nbsp;
              		<input 	type		='text' 
						class		='combo' 
						name		='val_descuento1'  
						value		=''
