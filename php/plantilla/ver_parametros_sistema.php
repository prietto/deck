...
<body >
			...
			<table width="100%" border="0" cellpadding="3" align="center" >
              ...
              <tr>
                <td colspan="3" align="center" class="">
                  <?
                    $display_menu_empresa = ($_COOKIE['menu_info_empresa'] == 1) ? "" : "display:none;"; 
                  ?>
                  <div class="titulo_ventana_emergente btn btn-primary"  id="titulo_modulo_empresa" >INFORMACION DE LA EMPRESA</div>

                  <div id="box_info_empresa" style="<?=$display_menu_empresa?>">
                ...
                <tr class="combo_solicitud">
                  	<td colspan="3" nowrap="nowrap">
                    	<div style="display:inline-block; width:100%;" class="box_parametros_1">
                            <div style="">
                              <div class="titulo_ventana_emergente" id="titulo_modulo_empresa" >INFORMACION DEL SISTEMA</div>
    ...
    <p>&nbsp;</p>
     ...
     <? if($cod_usuario == 1){ ?>
      <div  id="btn_backup_clean">GENERAR BACKUP Y LIMPIAR SISTEMA</div>
     <? } ?>
