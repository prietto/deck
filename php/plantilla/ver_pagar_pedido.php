...
$(function(){
	...
	$("input[name=check_all]").change(function(){
		$('input[type=checkbox]').each( function() {			
			if($("input[name=check_all]:checked").length == 1){
				this.checked = true;
			} else {
				this.checked = false;
			}
...
<body >
	<div id="ventana_general"></div>
        ...
        <tr>
          <td align="center" class="titulo_principal">PAGAR PEDIDOS SELECCIONADOS</td>
        </tr>
      </table>
          <br />
        ...
        <tr>
          ...
          <table  width="90%" align="center"  >
            ...
            <thead>
                	<tr>
                	  <th colspan="7" align="left" class="titulo_tabla">Relacion de pedidos</th>
                	  </tr>
                	<tr class="menu_navegacion_paginas">
                        ...
                        <th width="12%" align="center" nowrap="nowrap">FORMA PAGO</th>
                        <th width="16%" align="center">VALOR TOTAL</th>
                ...
                <?PHP 
	$index_row = 0; 
	$val_total_sumatoria = 0;
  while($row=$db->sacar_registro($cursor_pedidos)){
		...
		$val_total_pago			= $row['val_total']; 
		$txt_nota				= $row['txt_observacion']; 
		$val_total_pago_parse	= $sis_genericos->formato_numero($val_total_pago);
		
		$val_total_sumatoria	= $val_total_pago + $val_total_sumatoria;
		if($index_row == 1)$class					= "class = 'alt'";
		
		
		if($index_row == 1)$index_row = 0; // reinicia el contador
  ...
  ?>
     	        ...
     	        <tr class="contenido" >
                    <td align="center"><input type="checkbox" name="reg_seleccionado[]" id="reg_seleccionado" value="<?=$cod_pedido?>" checked="checked" /></td>
                    <td align="center"><?=$cod_pedido?></td>
                    <td align="center"><?=$txt_cliente?></td>
                    <td align="center"><?=$txt_estado_pedido?></td>
                    <td align="center"><?=$txt_forma_pago?></td>
                    <td align="center"><?=$val_total_pago_parse?></td>
                    <td align="center"><?=$txt_nota?></td>
            </tr>
	   ...
	   $index_row++;
		...
		$val_total_sumatoria = $sis_genericos->formato_numero($val_total_sumatoria);
		?>
        </tbody>
        
        <tfoot>
        <tr class="titulo_menu" >
     	          <td align="center">&nbsp;</td>
     	          <td align="center">&nbsp;</td>
     	          <td align="center">&nbsp;</td>
     	          <td align="center">&nbsp;</td>
     	          <td align="center">&nbsp;</td>
     	          <td align="center"><?=$val_total_sumatoria?></td>
     	          <td align="center">&nbsp;</td>
   	          </tr>
        <tfoot>
                ...
                <table width="100%" border="0" cellspacing="2" cellpadding="2">
                  ...
                  <tr>
                    <td align="center">
                    	...
                    	<input type="button" name="esc" id="esc" class="contenido" value="&lt;&lt; Atras" onclick="f_esc()"/></td>
