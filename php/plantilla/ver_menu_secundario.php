			    ...
			    <table width="100%" height="100%"  border="0" align="center"  cellpadding="0" cellspacing="0" class="tabla_principal">
                 ...
                 <tr>
					...
					<!-- InstanceBeginEditable name="EditRegion3" -->
                       ...
                       <h2>PARAMETROS SISTEMA</h2></div>
                   <div style="min-height:80%;" >
                   <table width="40%"  border="0" align="center" cellpadding="5" cellspacing="5">
						<? 
                        $num_registros = $db->num_registros($cursor_tablas);
						$contador = 0;
                        for($i=0;$i<$num_registros;$i++){
							$contador++;
                            $row = $db->sacar_registro($cursor_tablas,$i);
                            
                            $txt_nom_tabla	  	= strtoupper($row['txt_alias']);
                            $cod_tabla_pk		= $row['cod_tabla'];
                        ...
                        ?>
                              ...
                              <tr>
                                <td width="12%" align="center"><img src="../../imagenes/sistema/c<?=$contador?>.png"></td>
                                <td width="88%" valign="middle" class="titulo_negro">
									<a class="float-shadow" href="javascript:void(0);" 
                                    	onClick="f_ver_consultar_tabla(<?=$cod_tabla_pk?>);"><?=$txt_nom_tabla?></a>
                                </td>
                              </tr>
