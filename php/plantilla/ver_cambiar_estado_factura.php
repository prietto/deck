...
<title>ESTADOS DE FACTURAS - DECK</title>
...
<body >
	<div id="ventana_general"></div>
        ...
        <tr>
          <td align="center" class="titulo_principal">ACTUALIZACION DE ESTADO DE FACTURACION</td>
        </tr>
      </table>
          <br />
        ...
        <tr>
          <td width="23%">&nbsp;</td>
          <td width="54%"><table width="94%" border="0" align="center">
            <tr>
              <td colspan="6" nowrap="nowrap" class="titulo_tabla"> Relacion de Facturas</td>
            </tr>
            <tr class="menu_navegacion_paginas"  >
             <td nowrap="nowrap" class="combo_solicitud"><input  type="checkbox" onclick="marcar(this);" checked="checked" /></td>
              ...
              <td class="combo_solicitud">Entidad</td>
              <td nowrap="nowrap">Estado</td>
              <td nowrap="nowrap">Fecha Generada</td>
                <td nowrap="nowrap">Valor Total</td>
            </tr>
            ...
            <tr class="contenido">
            <td nowrap="nowrap"><input name="reg_seleccionado[]" type="checkbox" value="<?=$cod_factura?>" checked /></td>
              <td nowrap="nowrap"><?=$cod_factura?></td>
              <td nowrap="nowrap" ><?=$txt_entidad?></td>
            ...
            <tr>
              <td colspan="6" nowrap="nowrap" class="combo_solicitud">Por favor seleccione el nuevo estado para la(s) factura(s)</td>
            </tr>
            <tr>
              <td colspan="6" nowrap="nowrap" class="combo_solicitud">Estado: 
                <span class="texto_informativo">
                <select name='cod_estado_factura' class="combo" title="Por favor seleccione el nuevo estado para las facturas" onchange="f_actualizar_campos(this)" >
                  <option value='-1' selected='selected'></option>
                  <?php echo $cmb_estado_factura; ?>
                </select>
                </span></td>
              </tr>
            <tr>
            ...
            <?php if($cod_estado_factura == 8){ ?>
            <tr>
              <td height="32" colspan="6" align="center" bgcolor="#990000" class="contenido_claro">
                <p><strong><em class="pie_pagina_amarillo">HA ELEGIDO ANULAR LAS FACTURAS SELECCIONADAS, TENGA EN CUENTA QUE ESTE PROCESO NO TIENE REVERSA
               <BR />SE DESVINCULARA TODO LO RELACIONADO A LA FACTURA</em></strong></p></td>
              </tr>
            ...
            <tr>
              <td colspan="6" nowrap="nowrap"><table width="100%" border="0" cellspacing="2" cellpadding="2">
                <tr>
            ...
            <p>&nbsp;</p></td>
          <td width="23%" align="right" valign="bottom"><a href="javascript:f_eliminar_registro()">
      ...
      <input name="ind_recargar_pantalla"			type="hidden">	  
...
function  f_actualizar_campos(combo){
	f								= 	document.form1;
	//f.txt_campo_actualizado.value 	= 	combo.name;
	f.ind_recargar_pantalla.value 	= 	1;
	//f.ind_recargar_tipo_atencion.value 	= 	1;
	navegar(1032);
	f.ind_refrescar_pantalla.value 	= 	"";	
}
