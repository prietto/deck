...
<title>Consulta de factura Nro. <?=$cod_pk?></title>
...
?>
            ...
            <table width="100%">
                <tr class="titulo_tabla_detalle">
                        ...
                        <td>Valor Atencion</td>
                        <td>Valor Copago</td>                  
	             </tr>
                   <?php 
				   $sumatoria_val_compartido = 0;
				   while($row_autorizacion=$db->sacar_registro($copia_cursor_autorizaciones)){
					  $val_compartido = $row_autorizacion['val_compartido'];
						$sumatoria_val_compartido = $sumatoria_val_compartido+$val_compartido;
				 ...
				 while($row=$db->sacar_registro($cursor_atenciones)){
						
						$cod_atencion 				= $row['cod_atencion'];
						$txt_paciente				= $row['txt_paciente'];
						$txt_tipo_atencion			= $row['txt_tipo_atencion'];
						$fec_atencion				= $row['fec_atencion'];
						$txt_profesional_salud		= $row['txt_profesional_salud'];
						$num_autorizacion			= $row['num_autorizacion'];
						$cant_sesiones_autorizadas	= $row['cant_sesiones_autorizadas'];
						$cant_sesiones_faltantes	= $row['cant_sesiones_faltantes'];
						$val_atencion				= $row['val_atencion'];
						$val_copago					= $row['val_copago'];
						
						
						
						// INFORMACION DE LA FACTURA
						$row_factura 	= $factura->f_get_row($cod_pk);
						$val_iva_porc	= $row_factura['val_iva_porc'];
						$val_descuento	= $row_factura['val_descuento1'];
	
						
						
				 ?>
                   <tr class="contenido">
                   		<td nowrap="nowrap"><?php echo $cod_atencion; ?></td>
                   		<td nowrap="nowrap"><?php echo $txt_paciente; ?></td>
                        <td nowrap="nowrap"><?php echo $txt_tipo_atencion; ?></td>
                        <td nowrap="nowrap"><?php echo $fec_atencion; ?></td>                        
                        <td nowrap="nowrap"><?php echo $txt_profesional_salud; ?></td>
                        <td nowrap="nowrap"><?php echo $num_autorizacion; ?></td>
                     
                        <td nowrap="nowrap"><?php echo $val_atencion; ?></td>
                        <td nowrap="nowrap"><?php echo $val_copago; ?></td>                  
	             </tr>
                 
                 
                 
                 <? 
				 	$total_val_atencion = $total_val_atencion + $val_atencion;
					$total_val_copago = $total_val_copago + $val_copago;
				 
				 } 
				 
				 $sumatoria_val_atencion 	= $sis_genericos->formato_numero($total_val_atencion);
				 $sumatoria_val_copago		= $sis_genericos->formato_numero($total_val_copago);
                ...
                <tr class="contenido">
                        ...
                        <td nowrap="nowrap">&nbsp;</td>                        
                        <td nowrap="nowrap">&nbsp;</td>
                        <td nowrap="nowrap" class="menu_navegacion_paginas">SUMATORIA:</td>
                     
                        <td nowrap="nowrap" class="menu_navegacion_paginas"><?php echo $sumatoria_val_atencion; ?></td>
                        <td nowrap="nowrap" class="menu_navegacion_paginas"><?php echo $sumatoria_val_copago."   <span style='color:#FF0000'>( - )</span>"; ?></td>                  
	             </tr>
                  ...
                  <tr class="contenido">
                     ...
                     <td nowrap="nowrap" class="menu_navegacion_paginas">
					 <?php $subtotal = $total_val_atencion - $total_val_copago;
					 		$subtotal_coma = $subtotal;
							$subtotal_coma = $sis_genericos->formato_numero($subtotal_coma);
					 		echo $subtotal_coma;
                  ...
                  <tr class="contenido">
                    ...
                    <td nowrap="nowrap" class="menu_navegacion_paginas"><?php 
						$val_descuento_coma = $sis_genericos->formato_numero($val_descuento);
						echo $val_descuento_coma." <span style='color:#FF0000'>( - )</span>"; ?></td>
                  </tr>
                  <?php } ?>
                  
                  <?php if($sumatoria_val_compartido){ ?>
                  ...
                  <tr class="contenido">
                    ...
                    <td nowrap="nowrap">&nbsp;</td>
                    <td nowrap="nowrap" class="menu_navegacion_paginas">&nbsp;</td>
                    <td nowrap="nowrap" class="menu_navegacion_paginas">VALOR COMPATIDO:</td>
                    <td nowrap="nowrap" class="menu_navegacion_paginas"><?php 
						$sumatoria_val_compartido_coma = $sis_genericos->formato_numero($sumatoria_val_compartido);
						echo $sumatoria_val_compartido_coma." <span style='color:#FF0000'>( - )</span>"; ?></td>
                  </tr>
                  ...
                  <tr class="contenido">
					...
					$val_iva_pesos = (($subtotal-$val_descuento)-$sumatoria_val_compartido)*$val_iva_porc/100;
                  ...
                  <tr class="contenido">
                    ...
                    <td nowrap="nowrap" class="menu_navegacion_paginas"><?php 
						$total_factura = ((($subtotal-$val_descuento)+$val_iva_pesos)-$sumatoria_val_compartido);
            ...
            <table width="100%">
              <tr>
                <td colspan="9" class="titulo_principal">AUTORIZACIONES (Informacion de todas las autorizaciones relacionadas en la factura)</td>
                </tr>
              <tr class="titulo_tabla_detalle">
                <td width="10%">Nro. Autorizacion</td>
                <td width="13%">Tipo Atencion</td>
                <td width="9%">Entidad</td>
                <td width="15%">Paciente</td>
                <td width="10%">Estado</td>
                <td colspan="2" align="center">Fechas</td>
                <td colspan="2" align="center">Dias Vigencia</td>
                </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td width="14%" align="center" class="menu_navegacion_paginas">Registro</td>
                <td width="16%" align="center" class="menu_navegacion_paginas">Expedicion</td>
                <td width="6%" align="center" class="menu_navegacion_paginas">Totales</td>
                <td width="7%" align="center" class="menu_navegacion_paginas">Faltantes</td>
              </tr>
              
              
              <?php
			  	while($row=$db->sacar_registro($cursor_autorizaciones)){
					...
					$txt_paciente				= $row['txt_paciente'];
					$txt_estado_autorizacion	= $row['txt_estado_autorizacion'];
					$fec_registro				= $row['fec_registro'];
					$fec_expedicion				= $row['fec_expedicion'];
					$dias_v_totales				= $row['dias_vigencia'];
					$fec_actual					=	date("Y-n-j H:i:s");
					$tiempo_transcurrido 		= (strtotime($fec_actual)-strtotime($fec_expedicion));
					// se divide por segundos(60), minutos(60), horas(24) finalmente da el numero de dias
					$tiempo_transcurrido		= (($tiempo_transcurrido / 60)/60)/24;
					$tiempo_transcurrido		=  floor($tiempo_transcurrido);


					if($fec_expedicion)$dias_faltantes				=	$dias_v_totales - $tiempo_transcurrido;
					
					if($dias_faltantes < 0)$dias_faltantes = 0;					
					
			  
			   ?>
              <tr class="contenido">
                <td height="22"><?php echo $num_autorizacion; ?></td>
                <td nowrap="nowrap"><?php echo $txt_tipo_atencion; ?></td>
                <td><?php echo  $txt_entidad; ?></td>
                <td nowrap="nowrap"><?php echo $txt_paciente; ?></td>
                <td width="10%" align="center"><?php echo $txt_estado_autorizacion;  ?></td>
                <td width="14%" align="center"><?php echo $fec_registro; ?></td>
                <td width="16%" align="center"><?php echo $fec_expedicion;  ?></td>
                <td width="6%" align="center"><?php echo $dias_v_totales;  ?></td>
                <td width="7%" align="center"><?php echo $dias_faltantes;  ?></td>
              </tr>
