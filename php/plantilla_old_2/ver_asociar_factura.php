...
<title>Salud Fisica Integral -  Registro de
...
<body >
	<div id="ventana_general"></div>
        ...
        <tr>
          <td align="center" class="titulo_principal">RELACION DE FACTURAS GENERADAS - PERIODO FACTURACION</td>
        </tr>
      </table>
          <br />
        ...
        <tr>
          <td width="18%">&nbsp;</td>
          <td width="64%"><table width="106%" border="0" align="center">
            <tr>
              <td colspan="6" nowrap="nowrap" class="titulo_tabla"> Relacion de Facturas</td>
            </tr>
            <tr class="menu_navegacion_paginas"  >
             
              <td width="11%" nowrap="nowrap" class="combo_solicitud">Factura</td>
              <td width="20%" class="combo_solicitud">Entidad</td>
              <td width="13%" nowrap="nowrap">Estado</td>
              <td width="16%" nowrap="nowrap">Fecha Generada</td>
                <td width="15%" nowrap="nowrap">Valor Total</td>
                  <td width="25%" nowrap="nowrap">Periodo de Facturacion</td>
            </tr>
            
            <?php 
			$arr_facturas = array();
			
			while($row=$db->sacar_registro($cusror_facturas)){
						...
						$valor_total			= $row['val_total'];
						$valor_total			= $sis_genericos->formato_numero($valor_total);
						
						array_push($arr_facturas,$cod_factura);
            ...
            <tr class="contenido">
              ...
              <td nowrap="nowrap"><?=$fec_registro?></td>
               <td nowrap="nowrap"><?=$valor_total?></td>
                <td nowrap="nowrap"><span class="texto_informativo">
                  <select name='cod_periodo_facturacion[]' class="combo" title="Por favor seleccione el periodo de facturacion">
                    <option value='-1' selected='selected'></option>
                    <?php echo $cmb_periodo_facturacion; ?>
                  </select>                  
                </span>
			...
			$cadena_facturas = implode(',',$arr_facturas);
            ...
            <p>&nbsp;</p></td>
          <td width="18%" align="right" valign="bottom"><a href="javascript:f_eliminar_registro()">
      ...
      <input name="cod_facturas"						type="hidden" 		value="<?=$cadena_facturas?>" />
	...
	f.ind_refrescar_pantalla.value 	= 	"";	
      ...
      <tr>
        <td align="center"  valign="bottom"  class="td_footer"  >
        	<div>Todos los derechos reservados © 2019</div>
