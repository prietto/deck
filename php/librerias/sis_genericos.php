...
if(class_exists('sis_genericos') != true){
	class sis_genericos{
		...
		/*=====2014/11/03=======================================D E C K===>>>>
		DESCRIPCION: 	Retorna input fecha
		AUTOR:			Luis Prieto
		---------------------------------------------------------------------------					
		PARAMETRO		DESCRIPCION 
		$fecha			Nombre del input
		...
		FECHA	AUTOR		MODIFICACION
		===========================================================================*/
		function p_limpiar_sistema(){
			global $db;

		
			//sentencia sql para limpiar las tablas principales del sistema

			$array_tabla = array();

			$array_tabla[] = 'cliente';
			$array_tabla[] = 'detalle_empleado_pago';
			$array_tabla[] = 'detalle_nombre_archivos';
			$array_tabla[] = 'empleado';
			$array_tabla[] = 'empleado_pago';
			$array_tabla[] = 'entrada_insumo';
			$array_tabla[] = 'entrada_producto';
			$array_tabla[] = 'factura';
			$array_tabla[] = 'factura_anuladas';
			$array_tabla[] = 'factura_pago';
			$array_tabla[] = 'foto_cliente';
			$array_tabla[] = 'guarda_impuesto';
			$array_tabla[] = 'parametro_x_usuario';
			$array_tabla[] = 'insumo';
			$array_tabla[] = 'pedido';
			$array_tabla[] = 'pedido_compra';
			$array_tabla[] = 'pedido_detalle';
			$array_tabla[] = 'pedido_detalle_compra';
			$array_tabla[] = 'periodo_facturacion';
			$array_tabla[] = 'producto';
			$array_tabla[] = 'proveedor';
			$array_tabla[] = 'salida_insumo';
			$array_tabla[] = 'seg_navegacion_estadistica';

			$num_tablas = count($array_tabla);				
			for($i=0;$i<$num_tablas;$i++){
				$query = "truncate table ".$array_tabla[$i];
				$db->consultar($query);
			}
			exit;
		...
		FECHA	AUTOR		MODIFICACION
		===========================================================================*/
		function f_crea_input_fecha($txt_nombre_columna,$value=NULL){
			if(!$txt_nombre_columna) return false;
		...
		===========================================================================*/
		 function f_get_diferencia_dias_habiles($fec_inicial,$fec_fin){
			...
			for($i=1;$str_fec_inicial<$str_fec_final;$i++){
				...
				if($date != 7){ // ME FIJO QUE NO SEA DOMINGO
		...
		function f_get_valida_dia_habil($fecha){
			...
			if($num_registros == 0 && $diasemana != 7)return true; // si no es festivo y no es domingo
			else return false;
...
//						print_r($array_request);						
		...
		FECHA	AUTOR		MODIFICACION
		===========================================================================*/
		function f_crar_paginador_mysql_con_datos_v0(
				$num_pagina					,
				$num_max_registros			,
				$num_registros 				,
				$txt_estilo_seleccionado	,
