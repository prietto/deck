...
if(!$reg_seleccionado){
	...
	array_push($arr_parametro,''); 	//registra el codigo del mensaje que se debe mostrar
	$proceso			= NULL;		//no procesa nada
	$consulta			= "ver_registrar_descuento.php"; //lo envia a la pagina anterior
	$salida				= "ver_registrar_descuento.php"; //lo envia a la pagina anterior
}
/*if(!$val_descuento1){
	array_push($arr_mensajes,'1'); 	//registra el codigo del mensaje que se debe mostrar
	array_push($arr_parametro,'VALOR DESCUENTO'); 	//registra el codigo del mensaje que se debe mostrar
	$proceso			= NULL;		//no procesa nada
	$consulta			= "ver_registrar_descuento.php"; //lo envia a la pagina anterior
	$salida				= "ver_registrar_descuento.php"; //lo envia a la pagina anterior
}*/
