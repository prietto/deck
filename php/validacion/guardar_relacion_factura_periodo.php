...
$arr_periodos = $_REQUEST['cod_periodo_facturacion'];
$arr_facturas = explode(',',$_REQUEST['cod_facturas']);

// si existe uno en blanco
if(in_array('-1',$arr_periodos)){
	array_push($arr_mensajes,'1'); 	//registra el codigo del mensaje que se debe mostrar
	array_push($arr_parametro,'El Periodo de facturacion'); 	//registra el codigo del mensaje que se debe mostrar
	$proceso			= NULL;		//no procesa nada
	$consulta			= "ver_asociar_factura.php"; //lo envia a la pagina anterior
	$salida				= "ver_asociar_factura.php"; //lo envia a la pagina anterior
}
