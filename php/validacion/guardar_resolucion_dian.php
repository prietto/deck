...
$cant_activo = $resolucion_dian->f_get_row_activo();	
if(!$row_usuario){
...
}else if($cant_activo > 1){
			array_push($arr_mensajes,'17'); 									//Registra el codigo del mensaje que se debe mostrar
			array_push($arr_parametro,$txt_alias); 							//Nombre del campo not null
			$proceso			= NULL;										//No procesa 
			$consulta			= "ver_registrar_dato_tabla_autonoma.php";	//Regresa a  la pagina anterior
			$salida				= "ver_registrar_resolucion_dian.php";	//Regresa a  la pagina anterior
