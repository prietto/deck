...
$txt_consulta 	= "ver_registrar_entrada_producto.php";
$txt_salida		= "ver_registrar_entrada_producto.php";

/*if(!empty($cod_navegacion_anterior)){ // si no esta vacia la variable
	$new_flujo_navegacion 		= $seg_navegacion->f_ver_navegacion($cod_navegacion_anterior);
	$txt_consulta 	= $new_flujo_navegacion["txt_consulta"];
	$txt_salida		= $new_flujo_navegacion["txt_salida"];
}*/
...
if(!$row_usuario){
	...
	$consulta				= "$txt_consulta";	//Regresa a  la pagina anterior
	$salida					= "$txt_salida";	 //Regresa a  la pagina anterior
...
// debe validar que exista un proveedor o un empleado registrado
if(!$cod_proveedor && !$cod_empleado){
	array_push($arr_mensajes,'43'); 	//registra el codigo del mensaje que se debe mostrar
	array_push($arr_parametro,''); 	//registra el codigo del mensaje que se debe mostrar
	$proceso				= NULL;		//no procesa nada
	$consulta				= "$txt_consulta";	//Regresa a  la pagina anterior
	$salida					= "$txt_salida";	 //Regresa a  la pagina anterior	
...
if($cod_proveedor != NULL &&  $cod_empleado != NULL && 1==2){
