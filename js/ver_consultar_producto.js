...
===========================================================================*/
var f_ver_ultimos_movimientos = function($this){
	...
	if(error>0){
		...
		navegar_ajax_return(1093,function(a){
...
/*=====2010/03/18====================================Arellano Company===>>>>
DESCRIPCION: 	Metodo para mostrar pantalla de la entrada de productos
AUTOR:			Luis Prieto
---------------------------------------------------------------------------					
PARAMETRO		DESCRIPCION 
===========================================================================*/
function f_entrada_productos($this){

	var seleccionados =	$('input[name="reg_seleccionado[]"]:checked').length;
	if(seleccionados < 1){
		var data = "Por favor seleccione un producto y a continuacion intente nuevamente";
